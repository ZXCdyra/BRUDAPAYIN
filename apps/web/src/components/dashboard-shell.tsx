      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-border-primary px-5">
          <div className="flex items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-accent font-bold text-white text-[10px]">
              Br
            </div>
            <div>
              <p className="text-sm font-semibold text-text-primary capitalize">{role}</p>
              <p className="text-xs text-text-muted">
                {role === 'trader' ? tShell('panelBrand') : 'BrudaPay'}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="border-t border-border-primary p-4">
          ...
          <div className="mb-3 flex items-center gap-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-surface-elevated text-xs font-medium text-text-secondary">
              {(user?.login ?? user?.email)?.charAt(0).toUpperCase() ?? '?'}
            </div>
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-medium text-text-primary">{user?.login ?? user?.email ?? '—'}</p>
