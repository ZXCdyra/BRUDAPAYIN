...
import { TraderCommissionTiersPanel } from './trader-commission-tiers-panel';
...
export function TraderDetailModal({
  ...
  const { data: traderDetail, isLoading: detailLoading } = useQuery<TraderDetail>({
    ...
    queryFn: async () => {
      ...
      return {
        id: raw.id,
        login: raw.user.login ?? raw.user.email ?? '—',
        ...
        <div className="mx-auto max-w-6xl space-y-10">
          {canEditStaff && traderId ? (
            <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
              ...
              <TraderCommissionTiersPanel traderId={traderId!} canEdit={canEditStaff} />
