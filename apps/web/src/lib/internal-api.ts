...
export const internalPaths = {
  ...
  adminCascadeCoverage: (currency = 'RUB') =>
  ...
  traderCommissionTiers: (id: string) => `/api/traders/${id}/commission-tiers`,
  ...
  merchantBalanceReset: (id: string) => `/api/merchants/${id}/balances/reset`,
  ...
  // Top-up requests (trader)
  traderTopUpRequests: '/api/trader/topup-requests',
  traderTopUpRequestCreate: '/api/trader/topup-requests',

  // Top-up requests (admin)
  adminTopUpRequests: '/api/admin/topup-requests',
  adminTopUpRequestApprove: (id: string) => `/api/admin/topup-requests/${id}/approve`,
  adminTopUpRequestReject: (id: string) => `/api/admin/topup-requests/${id}/reject`,
} as const;
