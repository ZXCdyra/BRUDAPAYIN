...
export class UsersController {
  ...
  async create(@Body() dto: CreateUserDto) {
    return this.usersService.create(dto.login, dto.password, dto.role, {
      email: dto.email,
  ...
  @ApiOperation({
    ...
    description: 'Login, optional contact email, active flag, and merchant display name (for MERCHANT users). Role cannot be changed.',
  })
