...
| Trader   | trader@p2p.local     | http://localhost:3000/trader     | Payout limits: 500–150 000 RUB     |
...
Seed also creates: currencies (RUB, USDT), all RF banks, trader balances, merchant balances, API keys, sample pay-in orders, assigned pay-out orders, and pool (unassigned) pay-out orders. Market: Russia (RU/RUB), rate source — Rapira USDT/RUB.
